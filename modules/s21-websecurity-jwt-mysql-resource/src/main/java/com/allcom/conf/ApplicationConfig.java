...
class ApplicationConfig {
	...
	public static PropertyPlaceholderConfigurer propertyPlaceholderConfigurer() {
		...
		ppc.setLocation(new FileSystemResource("/appconf/s21-websecurity-jwt-mysql-resource/app.properties"));        //JPA的标准配置文件
		return ppc;
	}

	@Bean
	public static JoranConfigurator readLogbackPropertyFile(){
		File logbackFile = new File("/appconf/s21-websecurity-jwt-mysql-resource/logback.xml");
