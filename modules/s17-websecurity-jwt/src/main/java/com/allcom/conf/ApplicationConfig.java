...
class ApplicationConfig {
	...
	public static PropertyPlaceholderConfigurer propertyPlaceholderConfigurer() {
		...
		ppc.setLocation(new FileSystemResource("/appconf/s17-websecurity-jwt/app.properties"));        //JPA的标准配置文件
		return ppc;
	}

	@Bean
	public static JoranConfigurator readLogbackPropertyFile(){
		File logbackFile = new File("/appconf/s17-websecurity-jwt/logback.xml");
