...
//        }
//        String ret = "";
//        String regphone="121213asdfasd|asdfaasdfasdfsdf|asdfasdfasadf";
//        String[] tmpArray = regphone.split("\\|");
//            for(String tmpNumber:tmpArray){
//                if(!tmpNumber.equals("") && tmpNumber.length()>6) {
//                    if(ret.endsWith("")){
//                        ret = tmpNumber.substring(0, 3) + "***" + tmpNumber.substring(tmpNumber.length() - 3);
//                    }else{
//                        ret = ret + "|" +tmpNumber.substring(0, 3) + "***" + tmpNumber.substring(tmpNumber.length() - 3);
//                    }
//                }
//        }
